...
<form  action="#"method="post" id="form1" class="form">
    <div class="emailbox2" style="justify-self:center;">

        <div class="emailbox3" style="margin-bottom:0;justify-self:center;justify-content:center;" id="email-label">
        <input style="postion:absolute;" class="email" type="text" required  name="email"  pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" required="" placeholder="enter you email" title="That aint no email!" value="example765@gmail.com"   id="email-field" >
...
<a href="#top" onmouseover="this.style.color='skyblue';"
   onmouseout="this.style.color='white';">
   <div class="foot-panel" 
        onmouseover="this.style.backgroundColor='orange';" 
        onmouseout="this.style.backgroundColor='rgba(4, 77, 34, 0.877)';">
       back to top
   </div>
</a>
